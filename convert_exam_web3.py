...
def markdown_to_pdf(md_file, pdf_file):
    ...
    # Conversion HTML -> RichText (simplifié)
    # On va parser manuellement le markdown
    ...
    while i < len(lines):
        ...
        # Code block (```)
            ...
            story.append(Paragraph(f"<font face='Courier'>{code_text}</font>", style_code))
            story.append(Spacer(1, 0.1*inch))
        ...
        # Paragraphe normal
            ...
            # Correction: remplacer correctement
            import re
...
if __name__ == '__main__':
    ...
    md_file = 'exam_web3_sujetB_CORRIGE.md'
    pdf_file = 'exam_web3_sujetB_CORRIGE.pdf'
